...
| Trades | 391 (refreshed 2026-09-15, through 2026-09-14's data) | 226 (refreshed 2026-09-04, through 2026-09-03) |
| Win rate | 45.52% | 55.8% |
| Total P&L | ₹217,556 | ₹42,778 |
| Max drawdown | −₹13,944 (per-trade series) | −₹14,943 |
| Calmar | 15.6 (per-trade, methodology-comparable to the mult-2.5 candidate) | 2.86 (unitless) / 4.84 (annualized, ₹1L capital basis) |
| Cross-validation | Cross-validated on CRUDEOIL 2026-09-07, re-validated 2026-09-09 at T1=2.2%, **refreshed again 2026-09-15 through 2026-09-14's data** — Calmar 9.48, edge held (see `prometheus_backtest/README.md`'s Phase 3 caveat #3) | Confirmed on CRUDEOIL (full-size contract) before being trusted |
