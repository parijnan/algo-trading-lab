...
# Paths
# ---------------------------------------------------------------------------
# All paths relative to apollo_production/ — the working directory at runtime
...
# ---------------------------------------------------------------------------
# Credentials are read from data/user_credentials.csv at login.
# Same file and column structure as Artemis.
...
# 200 candles = ~10 trading days of history. Adjustable without code changes.
...
# ---------------------------------------------------------------------------
# Entry filters (D-R-P2c additions)
...
# These are dead zones where market is oscillating rather than trending.
