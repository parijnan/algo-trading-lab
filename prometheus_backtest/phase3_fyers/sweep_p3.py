...
**phase3_fyers copy**: identical to ../phase3/sweep_p3.py except the data
source -- this directory's own data_loader_fyers (Fyers-sourced,
Angel-One-gap-filled for 2026-03-13 through 2026-06-29) instead of
../data_loader.py's plain Angel-One-only loader. ST_MULTIPLIER_GRID is
already restricted to [2.0] in this directory's own configs_p3.py, the
already-decided production value -- this is not a fresh multiplier sweep.
"""
