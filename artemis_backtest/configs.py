...
# Contract schedule (generated by generate_contracts.py, manually editable)
CONTRACTS_FILE          = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'contracts.csv')
