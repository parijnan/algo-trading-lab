...
| `nifty_daily_index_angel.py` | Same as above via AngelOne — updates same-day after market close (preferred live source) | VPS or Laptop | Manual / as needed |
...
├── nifty_daily_index.py            # Official daily Nifty OHLC via ICICI Breeze
├── nifty_daily_index_angel.py      # Same via AngelOne — same-day updates (preferred live source)
