...
DATA_DIR            = os.path.join(os.path.dirname(__file__), "data_adaptive_exit")
os.makedirs(DATA_DIR, exist_ok=True)

TRADE_LOGS_DIR      = os.path.join(DATA_DIR, "trade_logs")
TRADE_SUMMARY_FILE  = os.path.join(DATA_DIR, "trade_summary.csv")

# ---------------------------------------------------------------------------
# Entry
# ---------------------------------------------------------------------------
ENTRY_TIME              = '15:15'       # ALWAYS enter at 15:15 (HH:MM)
...
# Adaptive Exit
# ---------------------------------------------------------------------------
VIX_HANDOFF_THRESHOLD   = 16.0          # Exit at 10:25 if VIX < this, else 15:10
EARLY_EXIT_TIME         = '10:25'
LATE_EXIT_TIME          = '15:10'
...
# ---------------------------------------------------------------------------
ELM_EXIT_TIME           = '15:10'      # HH:MM — exit time on the day before sell expiry
