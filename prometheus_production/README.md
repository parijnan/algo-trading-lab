...
| Trades | 417 (corrected 2026-09-19, through 2026-09-18's data) | 226 (refreshed 2026-09-04, through 2026-09-03) |
| Win rate | 44.12% | 55.8% |
| Total P&L | ₹200,723 | ₹42,778 |
| Max drawdown | −₹16,831 (per-trade series) | −₹14,943 |
| Calmar | 11.93 (per-trade, methodology-comparable to the mult-2.5 candidate) | 2.86 (unitless) / 4.84 (annualized, ₹1L capital basis) |
| Cross-validation | Cross-validated on CRUDEOIL 2026-09-07, re-validated 2026-09-09 at T1=2.2%, corrected 2026-09-19 under the same contract-rollover fix as CRUDEOILM — Calmar 9.80, edge held (see `prometheus_backtest/README.md`'s Phase 3 caveat #3) — **both instruments now share the same corrected loader**, so this is a genuine like-for-like comparison | Confirmed on CRUDEOIL (full-size contract) before being trusted |
