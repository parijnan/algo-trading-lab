...
| `TRADE_UPDATE_SEC` | 60 | Slack update cadence while in-trade — raised from 20s 2026-09-11 after this alone contributed heavily to the workspace hitting Slack's own `message_limit_exceeded` cap; originally matched Artemis's/Athena's convention, not Iris's 10s |
